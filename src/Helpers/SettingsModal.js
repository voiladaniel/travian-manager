...
export const SettingsModal = ({ show, handleClose, handleChange, submitHandler, data, isLoading, isLoadingSettings }) => {
  return (
    show ?
        ...
        <Modal.Body>
          {!isLoadingSettings ?
            <Form onSubmit={submitHandler}>
              <Form.Row>
                <Form.Group as={Col} controlId="timeInterval">
                  <Form.Label>Time interval (seconds)</Form.Label>
                  <Form.Control type="text" name="timeInterval" value={data.timeInterval} onChange={handleChange} />
                </Form.Group>
              </Form.Row>
              <hr />
